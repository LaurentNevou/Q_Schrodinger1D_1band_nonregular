%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%% last update 8January2020, lne %%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This program solves the Schrodinger equation with m(z) on a NON-UNIFORM GRID
...
StrainModel  = 1;             % Activate Strain model (Shift the CBand only)
...
zt  = M(:,end-1)*1E-9;      % conversion of the length from Angstrom to meter
...
if FE_1band_Method==1
    ...
    j=j+1;
    Mass=me; % m=m(z)
    [E{j},psi{j}] = Schroed1D_FEM_1band_nonregular_f(z,V0,Mass,n);  % m = m(z)
...
%figure('position',[-3500 400 1000 700]);
